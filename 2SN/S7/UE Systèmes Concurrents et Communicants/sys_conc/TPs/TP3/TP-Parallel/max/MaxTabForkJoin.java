    ...
    static class PartialMax extends RecursiveTask<Integer> {
        ...
        public Integer compute() {
            if ((this.end - this.start) > this.threshold){
                PartialMax sp1 = new PartialMax(this.array, this.start, this.start + (this.end - this.start)/2, this.threshold);
                PartialMax sp2 = new PartialMax(this.array, this.start + (this.end - this.start)/2 , this.array.length, this.threshold);
