...
expression : UL_CROOUV sous_expression* sous_expression_1 UL_CROFER{ (print_endline "expression : UL_CROOUV sous_expression UL_CROFER") }

sous_expression : sous_expression_1 sous_expression_2{ (print_endline "sous_expression : sous_expression_1 sous_expression_2") }
...
sous_expression_2 :  UL_VIRG { (print_endline "sous_expression_2 : UL_VIRG") }
                | UL_PTVIRG { (print_endline "sous_expression_1 : UL_PTVIRG") }
