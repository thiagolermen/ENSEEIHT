...
int main(int argc, char* argv[]) {
  ...
  // If even, the message starts in the node 0 of the subcommunicator and turns clockwise multiplying by 2
  ...
  // If odd, the message starts in the last node of the subcommunicator and turns counter-clockwise diving by 2
  else {
